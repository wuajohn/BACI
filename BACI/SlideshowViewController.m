...
- (void)createBottomBar{
	...
	NSArray *newItems = [NSArray arrayWithObjects:leftSpace,
						 buttonItem1,buttonItem2,buttonItem3,buttonItem4,buttonItem5,rightSpace,nil];
...
- (void)showFullScreenPhoto:(NSString *)filename{
    ...
    [self.navigationController presentViewController:pictureViewController animated:NO completion:nil];
...
- (void)playVideo:(NSString *)filename
{
	...
	[self.navigationController presentViewController:videoViewController animated:NO completion:nil];
